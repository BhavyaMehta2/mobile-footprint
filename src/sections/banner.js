...
import bannerIcon3 from "assets/banner-icon-1-3.png";
import bannerIcon4 from "assets/banner-icon-1-4.png";
  ...
  return (
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Image sx={styles.logo} src="/logo.webp" alt="logo image" />
        <Heading as="h2">Be Smart Today, For A Better Tomorrow</Heading>
      </Container>
    </Box>
  );
};
